...
- Create Angular project with ng: `ng new articles.ui.angular --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`articles.ui.angular.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `articles.ui.angular.esproj`).
